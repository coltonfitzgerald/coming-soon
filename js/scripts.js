(function($){
	...
	function jgtContentTabs(){
		...
		tabsWrap.find('.main-section:lt(2)').hide();
		tabsNav.find('li:last').addClass('active');
	...
	function jgtGoogleMap(){
		...
		var mapLat = 36.055054,
			mapLong = -115.158626,
			mapInfo = '<div id="content">Cherry Pop Designs<br><a href="tel:+17027888216">(702) 788 8216</a></div>';
